...
export const renderLoginPage = (csrfToken) => {
    return `
        ${header}
                ...
                <div class="login-content flex-row-fluid d-flex flex-column p-10">
                    ...
                    <div class="d-flex flex-row-fluid flex-center">
                        <div class="login-form">
                            <form class="form" id="kt_login_singin_form" action="/login/auth" method="POST">
                                <input type="hidden" name="_csrf" value="${csrfToken}">
                                <div class="pb-5 pb-lg-15">
                                    <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Sign In</h3>
                                    <div id="login-message" class="btn btn-danger d-none"></div>
                                </div>
                                ...
                                <div class="pb-lg-0 pb-5 text-right">
                                    <button type="submit" id="kt_login_singin_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">
                                        Sign In
                                        <span id="login-loading" style="display: none; margin-left: 10px;">Loading...</span>
                                    </button>
                                </div>
                            </form>
                        </div>
